...
<!--------------------------------------------------------------------------------->
            <?php //data insert to form
                ...
                if(isset($_POST['product_save'])) {
                    ...
                    if(empty($cat_id) OR empty($subcat_id) OR empty($product_name) OR empty($product_company) OR empty($product_description) OR empty($product_price) OR empty($product_image) OR empty($product_offers) ){
