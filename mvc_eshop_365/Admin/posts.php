...
?>                                
                            ...
                            <div class="box">
                                <textarea name="post_title" class="form-control wmd-input" rows="1" id="wmd-input" placeholder="Enter Post Title !"></textarea>
                                <br/>
                                <header>
                                    ...
                                    <div class="tab-pane fade active in" id="markdown">
                                        <div class="wmd-panel">
                                            <div id="wmd-button-bar" class="btn-toolbar"></div>
                                                ...
                                                <textarea name="post_content" class="form-control wmd-input" rows="8" id="wmd-input" placeholder="Enter Post Content !"></textarea>
                                                <br/>

                                                <textarea class="form-control wmd-input" rows="2" name="post_tags" id="wmd-input" placeholder="Enter Post Tags !"></textarea>

                                        <div class="form-actions no-margin-bottom" id="Div1"><Br/>
                                            <input type="submit" name="post_save" value="Submit Post !" class="btn btn-primary" />
                                        </div>
                                        </div>
                                    </div>
