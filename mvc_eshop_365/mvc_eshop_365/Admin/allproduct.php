    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
        	...
        	echo '<h2>Product Cat_id  *  '.$data_allproduct['cat_id'].'</h2>';
        	echo '<h2>Product Subcat_id  * '.$data_allproduct['subcat_id'].'</h2>';
        	echo '<h2>Product Name *'.$data_allproduct['product_name'].'</h2>';
        	echo '<h2>Company Name *  '.$data_allproduct['product_company'].'</h2>';
        	echo '<h2>Product Details *  '.$data_allproduct['product_description'].'</h2>';
        	echo '<h2>Product Offfers *  '.$data_allproduct['product_offers'].'</h2>';
        	echo '<h2>Product price *  '.$data_allproduct['product_price'].'.00tk</h2>';
        ?>
      </div>
