...
<head>
    <meta charset="UTF-8" />
    <title>AIMS &mdash; 365 | Admin Panel</title>
...
<link class="jsbin" href="jquery-ui.theme.min.css" rel="stylesheet" type="text/css" />
...
function readURL(input) {
    ...
    <style>
        ul.wysihtml5-toolbar > li {  position: relative; }
    </style> 
