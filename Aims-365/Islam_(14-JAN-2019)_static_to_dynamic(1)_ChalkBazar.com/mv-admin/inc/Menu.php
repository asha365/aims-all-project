  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="<?php if($pg=='Laptop'){ echo 'active'; } ?>"><a href="index.php?page=Menu">Menu</a></li>

        <li class="<?php if($pg=='Car'){ echo 'active'; } ?>"><a href="index.php?page=Siteoption">Site Option</a></li>

        <li class="<?php if($pg=='Book'){ echo 'active'; } ?>"><a href="index.php?page=Inbox">Inbox (12)</a></li>
